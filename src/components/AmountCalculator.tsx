...
export default function AmountCalculator({
  ...
  const variants: LocalVariant[] = raw_variants.map(
    (cur_variant: { node: Variant }) => {
      return {
